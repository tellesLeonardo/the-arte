defmodule Teste.Artista do
  ...
  def changeset(artista, attrs) do
    artista
    |> cast(attrs, [:nome, :nome_artista, :senha, :email, :descricao, :miniatura_art])
    |> validate_required([:nome, :nome_artista, :senha, :email])
  end
end

defmodule TesteWeb.PageController do
  ...
  def login_user(conn, params) do
    ...
    art = Repo.get_by(Artista, nome: log["nome_log"], senha: log["senha_log"])
    |> case do
      nil ->
